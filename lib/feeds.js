...
const FEEDS = [
  ...
  /* Francophone business wires — the proprietary West-Africa angle (economy/FDI/markets). */
  { source: 'Agence Ecofin',     cat: 'economy', lang: 'fr', url: 'https://www.agenceecofin.com/composant/rss/rss-all' },
...
function categorize(text, feed){
  ...
  if (/football|\bfoot\b|\bcan\b|coupe d'afrique|coupe du monde|\bmatch\b|\bsport\b|joueur|aigles|basket|athl[ée]|olympique|\bligue\b|s[ée]lection|deschamps|mondial/.test(s)) return 'sport';
