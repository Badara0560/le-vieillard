...
const L = {
  fr: {
    ...
    briefText: 'Le Mali et l’Afrique en 2 minutes, chaque matin. Gratuit, sur Telegram ou WhatsApp.',
  ...
  en: {
    ...
    briefText: 'Mali & Africa in 2 minutes, every morning. Free, on Telegram or WhatsApp.',
...
/* Entrance: one gentle rise on load, staggered down the river. Server-rendered
   content is visible by default — the keyframe only adds the settle. */
...
const SUB = {
  fr: {
    title: 'Le Brief du matin — Le Vieillard',
    h1: 'Le Brief, chaque matin à 7 h',
    sub: 'Le Mali, le Sahel et l’Afrique en 2 minutes : les titres qui comptent, avec leurs sources. Sur Telegram ou WhatsApp, à la même heure chaque matin.',
  ...
  en: {
    title: 'The morning Brief — Le Vieillard',
    h1: 'The Brief, every morning at 7',
    sub: 'Mali, the Sahel and Africa in 2 minutes: the headlines that matter, with their sources. On Telegram or WhatsApp, at the same time every morning.',
